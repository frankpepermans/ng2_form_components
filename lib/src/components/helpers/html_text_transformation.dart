...
class HTMLTextTransformation {
  ...
  HTMLTextTransformation(String tag, String label,
      {Map<String, String> style, String className, Map<String,
          String> attributes, String id, bool enabled, bool allowRemove, bool shouldExpand, AsyncTransformation setup, bool doRemoveTag, String body})
      :
        this.tag = tag,
        this.label = label,
        this.body = body,
        ...
        this.setup = setup ?? (() =>
        new Future<HTMLTextTransformation>.value(new HTMLTextTransformation(
            tag, label, style: style,
            className: className,
            ...
            doRemoveTag: doRemoveTag,
            body: body
        ))),
        this.allowRemove = allowRemove ?? true,
        this.shouldExpand = shouldExpand ?? false,
